          ...
          <div className="grid gap-12 lg:grid-cols-[1fr_280px]">
            <div className="prose prose-slate dark:prose-invert max-w-none">
              ...
              <p className="mt-4 text-muted">
                Our team combines industry best practices with innovation to deliver results that scale. Get in touch
            ...
            <aside className="lg:border-l lg:border-border lg:pl-8">
              ...
              <Link
                href="/#contact"
                className="mt-6 inline-block rounded-xl border-2 border-axion px-4 py-2.5 text-sm font-medium text-axion transition-colors hover:bg-axion/10"
              >
                Make an enquiry
              </Link>
            </aside>
